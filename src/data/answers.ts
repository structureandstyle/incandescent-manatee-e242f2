...
export const ANSWERS = {
  ...
  q28: { value: "Blum for hinges and drawer systems, Hafele for furniture hardware and lighting, and other specialist hardware where the project calls for it.", about: "Hardware and ironmongery specified. Tension with the protocol's supplier-naming rule is logged in the ops defect register" },
  q29: { value: "We build furniture we are proud to put our name to. Everything is set out, levelled, plumb, fitted and finished with the same care in the details you see and the ones you do not. It should look right, feel right and be built to last.", about: "The standard worked to. He refused the cheaper-fitter comparison framing outright" },
